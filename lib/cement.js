...
class Cement {
   ...
   * @param {String} destination - name of the destination Brick
   */
    ...
    if ('links' in source.configuration) {
      ...
      if (typeof link !== 'undefined') {
        canSend = link.jobs.some((jobdefinition) => {
          return (context.data.nature.type === jobdefinition.type)
            && (context.data.nature.quality === jobdefinition.quality);
        });
      }
    }
    return canSend;
 ...
 * @property {String} type - the type of the Job
 * @property {String} quality - the quality of the Job
 * @property {Brick} instance - the instance of the Brick
 */
