  ...
  constructor(configuration) {
    ...
    if (Array.isArray(configuration.tools)) {
      configuration.tools.forEach((tool) => {
        ...
        if (typeof tool.dependencies === 'object' && Object.keys(tool.dependencies).length) {
          Object.keys(tool.dependencies).forEach((dependency) => {
            const reference = tool.dependencies[dependency];
